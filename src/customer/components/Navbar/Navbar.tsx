import { Avatar, Badge, Box, Button, Divider, Drawer, IconButton, useMediaQuery, useTheme } from "@mui/material";
...
const Navbar = () => {
  ...
  // Updated function to match Home.js behavior
  ...
  return (
    <Box sx={{ zIndex: 2 }} className="sticky top-0 left-0 right-0 bg-white blur-bg bg-opacity-80 ">
        ...
        <div className="flex items-center gap-9">
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2 cursor-pointer" onClick={() => navigate("/")}> 
              ...
              />
              <h1 className="logo text-lg md:text-2xl text-[#00927c]"> Venda Shop </h1>
            </div>
          </div>
      ...
      {showSheet && selectedCategory && (
        <div onMouseLeave={() => setShowSheet(false)} onMouseEnter={() => setShowSheet(true)} className="categorySheet absolute top-[4.41rem] left-20 right-20 ">
