        ...
        <div>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-3'>
                <Card className='col-span-1 p-5 rounded-md space-y-4'>
                    ...
                    <h1 className='font-bold text-xl pb-1'>Kshs {sellers.report?.totalEarnings}</h1>
                    <Divider />
                    <p className='text-gray-600 font-medium pt-1'>
                        Last Payment: <strong>Kshs 0</strong>
                    </p>
                </Card>
                {/* <Card className='col-span-1 p-5 rounded-md space-y-4'>
                    <h1 className='text-gray-600 font-medium'>Payments To Be Settled</h1>
                    <h1 className='font-bold text-xl pb-1'>Kshs 0</h1>
                    <Divider />
                    <p className='text-gray-600 font-medium pt-1'>Next Payment: <strong>Kshs 0</strong></p>
                </Card> */}
            </div>
